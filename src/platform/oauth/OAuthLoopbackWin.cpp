...
class OAuthLoopbackWin final : public IOAuthLoopback {
public:
    OAuthLoopbackWin() = default;
    ~OAuthLoopbackWin() override { stop(); }

    OAuthLoopbackWin(const OAuthLoopbackWin&) = delete;
    OAuthLoopbackWin& operator=(const OAuthLoopbackWin&) = delete;
...
std::unique_ptr<IOAuthLoopback> makeOAuthLoopback() {
    return std::make_unique<OAuthLoopbackWin>();
}
